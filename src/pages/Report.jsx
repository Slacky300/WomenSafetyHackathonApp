            ...
            <div className='marginStyle '>
                <div class="container d-flex justify-content-center align-items-center">
                    <div class="row border rounded-5 p-3 bg-white shadow box-area reverseCol">
                        ...
                        <form method='post' enctype="multipart/form-data" class="col-md-6 right-box" onSubmit={handleSubmit}>
                            <div class="row align-items-center">
                                ...
                                <div class="input-group d-flex flex-row align-items-center mb-3">
                                    ...
                                    <div class="input-group d-flex flex-row align-items-center mb-3">
                                        <div class="form-outline flex-fill mb-0">
                                            <input type="file" value={note} onChange={handlefileChange} class="form-control form-control-lg border-dark fs-6" placeholder="Enter the pin of the Incident Place" required />
                                        </div>
                                    </div>
                                </div>
