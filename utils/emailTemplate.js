...
<body>
    ...
    <center>
        <div class="abc" style="
            ...
            <p style="color:white">Hey user you are recieving this mail because one of your close member added you as
                emergency contact</p>
            ...
            <div style="color: white;">
                ...
                <a style="text-decoration: none" href="https://maps.google.com/maps?q=${lat},${long}&hl=en&z=14&amp">
                    <button class="custom-btn btn-1">Check Location</button>
                </a>
                <br />
                <br />
            </div>
